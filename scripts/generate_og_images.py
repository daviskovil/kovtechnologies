...
SERVICES = [
    ...
    ("computers", "HARDWARE", "Computers", "Desktops, laptops, workstations and servers"),
    ("networking", "HARDWARE", "Networking", "Switches, routers, firewalls and Wi-Fi"),
    ("storage", "HARDWARE", "Storage & Backup", "SSD, NAS, SAN and backup appliances"),
    ("printers-supplies", "HARDWARE", "Printers & Supplies", "Printers, scanners, toner and ink"),
    ("monitors-displays", "HARDWARE", "Monitors & Displays", "Monitors, signage and projectors"),
    ("accessories", "HARDWARE", "Accessories", "Keyboards, docks, webcams and headsets"),
    ("phones-video", "HARDWARE", "Phones & Video", "VoIP, conferencing and room systems"),
    ("power-ups", "HARDWARE", "Power & UPS", "UPS, PDUs and surge protection"),
    ("office-equipment", "HARDWARE", "Office Equipment", "AV, shredders and workplace tech"),
    ("point-of-sale", "HARDWARE", "Point of Sale & Barcode", "POS terminals, scanners and receipt printers"),
    ("business-applications", "SOFTWARE", "Business Applications", "ERP, CRM, HCM and finance software"),
    ("security", "SOFTWARE", "Security Software", "Endpoint, firewall, email and identity"),
    ("virtualization", "SOFTWARE", "Virtualization", "Hypervisors, VDI and containers"),
    ("operating-systems", "SOFTWARE", "Operating Systems", "Windows, Linux and server OS"),
    ("data-databases", "SOFTWARE", "Data & Databases", "Databases, warehousing and analytics"),
    ("development", "SOFTWARE", "Dev & Web", "IDEs, DevOps and API tools"),
    ("graphics-design", "SOFTWARE", "Graphics & Design", "Creative, video and CAD software"),
    ("communication", "SOFTWARE", "Communication & Collaboration", "Email, chat and video"),
    ("licensing", "SOFTWARE", "Licensing & Subscriptions", "Volume licensing, SaaS and renewals"),
]
